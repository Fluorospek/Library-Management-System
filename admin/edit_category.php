...
$category_id="";
$category_name="";
$query="SELECT * FROM book_categories where category_id=$_GET[cid]";
...
if(isset($_POST['update_cat'])){
        $connection = mysqli_connect("localhost", "root", "password");
        $db = mysqli_select_db($connection, 'lms');
        $query="UPDATE book_categories SET name='$_POST[category_name]' where category_id=$_GET[cid]";
        $query_run=mysqli_query($connection,$query);
            ...
            <div class="col-md-4">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="category_name" class="form-control" value="<?php echo $category_name?>"required="true">
                    </div>
