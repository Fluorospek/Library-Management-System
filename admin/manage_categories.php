                    ...
                    <?php
                        ...
                        while($row=mysqli_fetch_assoc($query_run)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn" name=""><a href="edit_category.php?cid=<?php echo $row['category_id']?>">Edit</a></button>
                                    <button class="btn" name=""><a href="delete_category.php?cid=<?php echo $row['category_id']?>">Delete</a></button>
                                </td>
                            </tr>
                            <?php
                        }
