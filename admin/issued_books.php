...
$query = "select books.title,users.name,issued_books.issue_date,issued_books.return_date from issued_books,books,users where issued_books.book_id=books.book_id and issued_books.user_id=users.id";
